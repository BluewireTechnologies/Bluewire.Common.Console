...
namespace Bluewire.Common.Console.Tests
{
    ...
    public class ServiceAccountCredentialsFactoryTests
    {
        ...
        {
            var account = factory.Create(localSystem, null);
        ...
        {
            var account = factory.Create("System", "Password");
        ...
        {
            var account = factory.Create(@"DOMAIN\User", "Password");
            Assert.AreEqual(ServiceAccount.User, account.ServiceAccount);
        ...
        {
            var account = factory.Create(@"NETWORK SERVICE", null);
        ...
        {
            var account = factory.Create(@"LOCAL SERVICE", null);
